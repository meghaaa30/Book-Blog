        ...
        <section className="">
          <div className="row">
            ...
            <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
              ...
              <a href="https://github.com/taniishkaaa/Book-Blog" target="_blank" className="btn btn-primary btn-floating m-1" style={{ backgroundColor: "#6b4423", boxShadow: 'none' }} role="button"><GitHubIcon /></a>
            </div>
          </div>
        </section>
      </div>
